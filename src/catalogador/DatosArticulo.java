...
public class DatosArticulo {
    ...
    private int precio=0, tipo=0, precioVentaInicial=0, precioVentaFinal=0;
     ...
     * @param dImagen
     */
    public void setImagen(String dImagen){
        if(!dImagen.equals("false")){
            try {
                BufferedImage image = ImageIO.read(new File(dImagen)); 
